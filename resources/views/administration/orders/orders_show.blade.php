			...
			<div class="hpanel">
				<div class="panel-body">
					<div class="text-center">
						...
						<div class="m">
							<center>
								{!! HTML::image('images/empresa1.jpg', 'profile', ['class'=>'img-circle img-responsive']) !!}
							</center>
						</div>
						...
						<div class="panel-body">
							<div class="col-lg-6">
								...
								<div class="hpanel filter-item">
									...
									title="{!!$carbon->now('America/Bogota')->subDay(4)!!}">

									<div class="panel-body">
										<div class="pull-right text-right">
											<h4>{!!$carbon->now('America/Bogota')->subDay(4)->diffForHumans();!!} <i class="fa fa-calendar-check-o text-success"></i></h4>
										</div>
							...
							<div class="hpanel filter-item">
								<a href="#" title="{!!$carbon->now('America/Bogota')->addDays(2)!!}">
									<div class="panel-body">
										<div class="pull-right text-right">
											<h4>{!!$carbon->now('America/Bogota')->addDays(2)->diffForHumans();!!} <i class="fa fa-calendar-times-o text-danger"></i></h4>
										</div>
									...
									<div class="hpanel">
										<div class="panel-body">
											...
											<div class="stats-icon pull-right">
												...
												{!! HTML::image('images/profile.jpg', 'profile', ['class'=>'img-circle img-responsive']) !!}
								...
								<div class="col-lg-6">
									<div class="hpanel">
										<div class="panel-body">
											...
											<div class="stats-icon pull-right">
												{!! HTML::image('images/a2.jpg', 'profile', ['class'=>'img-circle img-responsive','width'=>'76']) !!}
											</div>
											<div class="m-t-xl">
								...
								<div class="col-lg-6">
									<div class="hpanel">
										<div class="panel-body">
											...
											<div class="stats-icon pull-right">
												{!! HTML::image('images/a4.jpg', 'profile', ['class'=>'img-circle img-responsive','width'=>'76']) !!}
											</div>
											<div class="m-t-xl">
		...
		<div class="panel-body">
			...
			<div class="col-md-9 trw-nnw">
				...
				<div class="trw-note">
					...
					<h5>{!!$carbon->now()->subMinutes(2)->diffForHumans();!!}</h5>
				...
				<div class="trw-note">
					<a class="close-note"><i class=" icon-cancel-circled-outline"></i></a><a class="close-note"><i class=" icon-share"></i></a>
					<h5>{!!$carbon->now()->subMinutes(56)->diffForHumans();!!}</h5>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi excepturi repellat laudantium numquam sunt quod nam reprehenderit iusto maxime, nemo, deserunt ipsum repellendus iure quia atque dolore quam provident earum.
				</div>

				<div class="trw-note">
					<a class="close-note"><i class=" icon-cancel-circled-outline"></i></a><a class="close-note"><i class=" icon-share"></i></a>
					<h5>{!!$carbon->now()->subMinutes(80)->diffForHumans();!!}</h5>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi excepturi repellat laudantium numquam sunt quod nam reprehenderit iusto maxime, nemo, deserunt ipsum repellendus iure quia atque dolore quam provident earum.
				</div>

				<div class="trw-note">    
					<a class="close-note"><i class=" icon-cancel-circled-outline"></i></a><a class="close-note"><i class=" icon-share"></i></a>          
					<h5>{!!$carbon->now()->subDay(1)->diffForHumans();!!}</h5>
