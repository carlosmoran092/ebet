...
{!! HTML::style('http://blueimp.github.io/Gallery/css/blueimp-gallery.min.css') !!}
    ...
    {!! HTML::style('vendor/file_upload/css/jquery.fileupload.css') !!}
    {!! HTML::style('vendor/file_upload/css/jquery.fileupload-ui.css') !!}
    {!! HTML::style('vendor/file_upload/css/jquery.fileupload-noscript.css') !!}
    {!! HTML::style('vendor/file_upload/css/jquery.fileupload-ui-noscript.css') !!}
