...
<head>
  ...
  <body class="contact-page">
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="row" >
                    <div style="background:#ffffff; border-radius:9px;" class="col-md-12 col-sm-12 col-xs-12  col-sm-offset-0 xs-offset-0">
                      ...
                      <div class="form-group  col-lg-12 card opt-aplication">
                          <button href="#" class="btn btn-md btn btn-cta-tertiary"><i class="icon-plus-5"></i> Add Files</button>

                          <button href="#" class="btn btn-md btn btn-cta-tertiary"><i class="icon-plus-5"></i> Add Text</button>
                      </div>
                ...
                <section class="col-md-5 go_aplication">
                    ...
                    <!--  -->
                    <article class="list-rate col-md-12">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <span class="col-md-8 col-sm-8 col-xs-8">
                             American English <i class="icon-right-1"></i> Armenian
                         </span>
                         <span class="col-md-4 col-sm-4 col-xs-4">
                            0.090
                        </span>
                    ...
                    <div class="col-md-12">
                        <span class="col-md-8 col-sm-8 col-xs-8">
                         American English <i class="icon-right-1"></i> Albanian
                     </span>
                     <span class="col-md-4 col-sm-4 col-xs-4">
                         0.080
                     </span>
             ...
             <div class="col-md-12">
                <span class="col-md-8 col-sm-8 col-xs-8">
                 Keep original style and format
             </span>
             <span class="col-md-4 col-sm-4 col-xs-4">
                 0
             </span>
     ...
     <div class="rate-aplication col-md-12">
        <span class="col-md-6 col-sm-6 col-xs-6">
            <h5>  <img src="images/small/United States.png" width="20" alt=""> American English</h5>
        </span>
        <span class="col-md-6 col-sm-6 col-xs-6">
            <h5> <img src="images/small/Armenia.png" width="20" alt=""> Armenian</h5>
        </span>
        <span class="col-md-12">
            <span><i class="icon-help-circled-3"></i></span> 1928 x 0.130 = 250.64
        </span>
    </div>
    ...
    <div class="rate-aplication col-md-12">
        ...
        <span class="col-md-6 col-sm-6 col-xs-6">
            <h5><img src="images/small/Albania.png" width="20" alt=""> Albanian</h5>
        </span>
        <span class="col-md-12">
            <span><i class="icon-help-circled-3"></i></span> 1928 x 0.120 = 231.36
        </span>
    </div>
