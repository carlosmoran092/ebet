...
<?php echo HTML::script('vendor/jquery-flot/jquery.flot.js'); ?>

<?php echo HTML::script('vendor/jquery-flot/jquery.flot.resize.js'); ?>

<?php echo HTML::script('vendor/jquery-flot/jquery.flot.pie.js'); ?>

<?php echo HTML::script('vendor/flot.curvedlines/curvedLines.js'); ?>

<?php echo HTML::script('vendor/jquery.flot.spline/index.js'); ?>
