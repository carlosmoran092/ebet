...
<!-- Javascript -->          
    ...
    <?php echo HTML::style('assets/plugins/jquery-1.11.2.min.js'); ?>

      <?php echo HTML::style('assets/plugins/bootstrap/js/bootstrap.min.js'); ?>

      <?php echo HTML::style('assets/plugins/bootstrap-hover-dropdown.min.js'); ?>

      <?php echo HTML::style('assets/plugins/back-to-top.js'); ?>

      <?php echo HTML::style('assets/plugins/jquery-placeholder/jquery.placeholder.js'); ?>

      <?php echo HTML::style('assets/plugins/FitVids/jquery.fitvids.js'); ?>

      <?php echo HTML::style('assets/plugins/flexslider/jquery.flexslider-min.js'); ?>


      <?php echo HTML::style('assets/js/main.j'); ?>
