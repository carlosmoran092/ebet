...
<?php echo HTML::style('vendor/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css'); ?>
			...
			<div class="col-md-8">
				...
				<div class="hpanel col-md-6">
					<div class="panel-body">
						...
						<div class="twr-lang">
							<?php echo HTML::image ('images/small/France.png'); ?><span class="name-language">French</span><i class="icon-cancel-4"></i>
						</div>
					</div>
				</div>
				...
				<div class="hpanel col-md-6">
					<div class="panel-body">
						...
						<div class="twr-lang">
							<?php echo HTML::image ('images/small/United States.png'); ?><span class="name-language">English</span><i class="icon-cancel-4"></i>
						</div>
						<div class="twr-lang">
							<?php echo HTML::image ('images/small/South Korea.png'); ?><span class="name-language">Korean</span><i class="icon-cancel-4"></i>
						</div>
